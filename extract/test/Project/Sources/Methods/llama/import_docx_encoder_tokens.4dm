...
/*
extract by tokens: this is a debug feature
you normally do not want the raw token IDs
although it is possible to use them collectively 
as a proxy for the whole document
*/
